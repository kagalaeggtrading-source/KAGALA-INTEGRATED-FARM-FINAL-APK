      ...
      {editingSale && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6 border border-slate-200">
            ...
            <form onSubmit={handleSaveEditSale} className="space-y-4 text-xs pt-4">
              <div>
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Customer / Buyer Name</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1 font-mono">Reference / OR #</label>
                <input
                  type="text"
                  value={editReferenceNumber}
                  onChange={e => setEditReferenceNumber(e.target.value)}
                  placeholder="Bank ref #, OR #"
                  className="w-full px-3 py-2 border border-slate-300 rounded-lg font-mono"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-bold shadow-xs transition-colors cursor-pointer flex items-center gap-1.5"
                >
